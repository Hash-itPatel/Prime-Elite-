...
BOT_TOKEN = environ.get('BOT_TOKEN', "6926442365:AAF3jAL13eZEeYQl_dZDnf-WtogOrUH5Y3sv")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002166032890'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002166032890').split()]
